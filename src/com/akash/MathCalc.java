...
public class MathCalc {
    ...
    public static void main(String[] args){
        ...
        System.out.println("The volume of the Earth is " + earthVolume + " cubic miles, the volume of the sun is " + sunVolume + " cubic miles,\n and the ratio of the volume of the Sun to the volume of the Earth is " + myRatio + ":1.");
